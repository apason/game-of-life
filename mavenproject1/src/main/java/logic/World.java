...
/**
 * Sisältää solutaulukon ja tiedot solujen tyypeistä sekä solutaulukkoon ja sen
 * kehitykseen liittyvät metodit.
 *
 * @author apa
 */
public class World implements Serializable {
    ...
    /**
     * Simuloitava maailma. Taulukollinen soluja jotka ovat joko kuolleita tai
     * edustavat tiettyä "lajia"
     */
    private Cell[][] map;
    /**
     ...
     * @param rules Sisältää kaikki mahdolliset Worlissa olevien solujen tyypiy
     * (Rules:t)
     */
    ...
    /**
     * Ohjelman kannalta oleellisin metodi. Suurin osa ohjelman suorituksesta
     * vietetään tässä metodissa. Hoitaa solukartan päivitystä.
     */
    public void evolve() {
        Cell[][] tmp = cloneMap();
     ...
     * @param generation2 Cell[][] taulukkoa vastaava seuraava sukupolvi
     * (laskuvaiheessa)
     */
    ...
    /**
     * Alustaa maailman: luo solut ja merkitsee jokaisen solun kuolleeksi (Rules
     * = null)
     */
    ...
    /**
     * Arpoo jokaiselle solulle jonkun rules listalla olevan tyypin tai arvon
     * null.
     */
